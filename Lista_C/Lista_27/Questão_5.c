...
bool saoIguaisRec(char string1[], char string2[], int posicao)
{
    bool iguais = true;
    if(string1[posicao] != '\0' && string2[posicao] != '\0' && iguais)
    {
        if(string1[posicao] != string2[posicao]) iguais = false;
        saoiguaisRec(string1, string2, posicao + 1)
    }
}
int main(void)
{
